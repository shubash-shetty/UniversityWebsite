				...
				<table>
					<tr>
						...
						<select name="subject" id="">
                            ...
                            <option value="English s1">English s1</option>
                            <option value="Mathematics M1">Mathematics M1</option>
                            <option value="Mechanical">Mechanical</option>
                            <option value="Electronics">Electronics</option>
                            <option value="Computer Programming">Computer Programming</option>
                            <option value="Programming Lab">Programming Lab</option>
                            
                            <option value="English s2">English s2</option>
							<option value="Physics">Physics</option>
                             <option value="Mathematics M2">Mathematics M2</option>
                            <option value="Electricals">Electricals</option>
							<option value="Civil">Civil</option>
                            <option value="Physics Lab">Physics Lab</option>
                            <option value="EGDL Lab">EGDL Lab</option>
